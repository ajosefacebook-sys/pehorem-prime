...
import { Gauge, Fuel, Calendar, MapPin, ChevronLeft, ChevronRight, Heart, Share2, MessageCircle, Phone, Sparkles, Check, ArrowLeft, Server, Cog } from "lucide-react"
...
export default function VehicleDetailPage({ params }: { params: { id: string } }) {
  const vehicle = featuredVehicles.find((v) => v.slug === params.id)
  if (!vehicle) notFound()
